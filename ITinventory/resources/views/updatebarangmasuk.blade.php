...
<div class="page-header">
    <h4 class="page-title">UPDATE DETAIL BARANG MASUK</h4>
    <ul class="breadcrumbs">
        ...
        <li class="separator">
            <a>Update Detail Barang Masuk</a>
        </li>
    </ul>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form method="post" enctype="multipart/form-data" action="/barang/masuk/update">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="largeInput">ID Barang Masuk</label>
                        <input class="form-control" type="text" placeholder="{{ $detail->masuk_id }}"
                    ...
                    <div class="modal-body modal-img">
                        <label for="largeInput"><strong>GAMBAR BARANG MASUK (sekarang)</strong></label>
