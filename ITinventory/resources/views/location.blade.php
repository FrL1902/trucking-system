    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="/editCategory">
                ...
                <div class="modal-body">
                    <div class="form-group" style="padding:0">
                        <label for="category_name" class="col-form-label" style="font-weight: bold; padding-bottom:0">Lokasi<span style="color: red">*</span></label>
                    ...
                    <div class="form-group" style="padding:20px 0px 0px 0px">
                        <label for="category_alamat" class="col-form-label" style="font-weight: bold; padding-bottom:0">Alamat<span style="color: red">*</span></label>
                        <input type="text" class="form-control form-control alamat-holder" style="border-color: #aaaaaa"
                            placeholder="Komputer Rakitan" id="category_alamat"
                            name="category_alamat">
                    </div>
                </div>
                <div class="modal-footer">
