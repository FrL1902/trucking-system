...
Route::get('/barang/masuk/delete/{id}', [BarangMasukController::class, 'hapus_barang_masuk']);
...
Route::get('/barang/history/detail/{id}', [HistoryItemController::class, 'view_detail_barang']);
